...
equation
  ...
  for i in 1:nCom loop
    dV_flow[i] = BuildingSystems.Airflow.Multizone.BaseClasses.powerLaw05(
      C=CVal,
      dp=dpAB[i],
      a=a,
      b=b,
...
BuildingSystems.Airflow.Multizone.DoorDiscretizedOperable</a>
...
BuildingSystems.Airflow.Multizone.BaseClasses.powerLawFixedM</a>.
</li>
