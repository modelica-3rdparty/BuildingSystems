...
equation
  ...
  VABpOpeClo_flow[1] = if Modelica.Math.isEqual(mOpe, 0.5, 1E-10)
    then
      BuildingSystems.Airflow.Multizone.BaseClasses.powerLaw05(
        C=CVal[1],
      ...
      BuildingSystems.Airflow.Multizone.BaseClasses.powerLawFixedM(
        C=CVal[1],
        dp=port_a1.p-port_a2.p,
        m=mOpe,
        a=a[1],
  ...
  VABpOpeClo_flow[2] = BuildingSystems.Airflow.Multizone.BaseClasses.powerLawFixedM(
    C=CVal[2],
    dp=port_a1.p-port_a2.p,
    m=mClo,
    a=a[2],
