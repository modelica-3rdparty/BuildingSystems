within BuildingSystems.Controls.OBC.CDL.Logical;
block Proof "Verify two boolean inputs"
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanInput u_s
    "Commanded status setpoint"
    annotation (Placement(transformation(extent={{-300,-20},{-260,20}}),
        iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanInput u_m
    "Measured status"
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanOutput yLocFal
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanOutput yLocTru
...
protected
  ...
  BuildingSystems.Controls.OBC.CDL.Logical.Not notBotFal "Not both false inputs"
    annotation (Placement(transformation(extent={{40,-160},{60,-140}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Not not2 "Logical not"
    annotation (Placement(transformation(extent={{-220,-50},{-200,-30}})));
  BuildingSystems.Controls.OBC.CDL.Logical.And falTru
  ...
  BuildingSystems.Controls.OBC.CDL.Logical.TrueDelay delChe1(
    final delayTime=feedbackDelay + debounce)
    "Delay the difference check"
    annotation (Placement(transformation(extent={{-180,-50},{-160,-30}})));
  BuildingSystems.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt
    "Convert boolean input to integer output"
    annotation (Placement(transformation(extent={{-100,-140},{-80,-120}})));
  BuildingSystems.Controls.OBC.CDL.Integers.Equal equSta
    "Output true if both inputs are same"
    annotation (Placement(transformation(extent={{-60,-140},{-40,-120}})));
  BuildingSystems.Controls.OBC.CDL.Conversions.BooleanToInteger booToInt1
    "Convert boolean input to integer output"
    annotation (Placement(transformation(extent={{-100,-180},{-80,-160}})));
  BuildingSystems.Controls.OBC.CDL.Logical.And botFal
    "Output true if both valid measured input and the setpoint input are false"
    annotation (Placement(transformation(extent={{0,-160},{20,-140}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.Constant conTru(
    final k=true)
    "True constant"
    annotation (Placement(transformation(extent={{-200,200},{-180,220}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Not not3
    "Input is invalid"
    annotation (Placement(transformation(extent={{-80,170},{-60,190}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Switch cheStaMea
    "Output true if there is no stable measured input"
    annotation (Placement(transformation(extent={{160,110},{180,130}})));
  BuildingSystems.Controls.OBC.CDL.Logical.TrueDelay delChe2(
    final delayTime=feedbackDelay + debounce)
    "Delay the difference check"
    annotation (Placement(transformation(extent={{-220,-10},{-200,10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.Constant conFal(
    final k=false)
    "False constant"
    annotation (Placement(transformation(extent={{40,132},{60,152}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Not notBotTru
    "Not both true inputs"
    annotation (Placement(transformation(extent={{-60,-90},{-40,-70}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Switch cheDif2
    "Output the difference check result if the difference check condition is satisfied"
    annotation (Placement(transformation(extent={{120,-90},{140,-70}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Switch cheStaMea1
    "Output true if there is no stable measured input"
    annotation (Placement(transformation(extent={{160,-130},{180,-110}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Timer pasDeb(
    final t=feedbackDelay + debounce)
    "Check if the debounce time has passed"
    annotation (Placement(transformation(extent={{-40,140},{-20,160}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Latch holTru
    "Hold the true output when the input changes to true"
    annotation (Placement(transformation(extent={{200,110},{220,130}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Latch holTru1
    "Hold the true output when the input changes to true"
    annotation (Placement(transformation(extent={{200,-130},{220,-110}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Or equInp
    "Output true if the measured input equal to the set point"
    annotation (Placement(transformation(extent={{20,10},{40,30}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Edge samInpEdg
    "Output a rising edge when both inputs are same"
    annotation (Placement(transformation(extent={{160,-30},{180,-10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.And valEqu
...
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Utilities.Assert\">
BuildingSystems.Controls.OBC.CDL.Utilities.Assert</a>
