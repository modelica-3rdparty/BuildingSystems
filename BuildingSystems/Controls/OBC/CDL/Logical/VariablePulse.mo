...
block VariablePulse "Generate boolean pulse with the width specified by input"
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput u(
    final min=0,
    final max=1,
    final unit="1")
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanOutput y
...
protected
  ...
  BuildingSystems.Controls.OBC.CDL.Logical.Edge edg2
    "Rising edge when there is a width change"
    annotation (Placement(transformation(extent={{60,-10},{80,10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Pre preBre
    "Break loop"
  ...
  block Cycle
    ...
    BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanInput go
  ...
  equation
    ...
    t_sta = t0 + BuildingSystems.Utilities.Math.Functions.round(
...
<p align=\"center\">
<img src=\"modelica://BuildingSystems/Resources/Images/Controls/OBC/CDL/Logical/VariablePulse.png\"
