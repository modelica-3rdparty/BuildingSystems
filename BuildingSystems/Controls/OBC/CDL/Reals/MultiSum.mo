...
block MultiSum
  ...
  parameter Real k[nin]=fill(1, nin)
    "Input gains";
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput u[nin]
...
<p>
See
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Reals.Validation.MultiSum\">
BuildingSystems.Controls.OBC.CDL.Reals.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
