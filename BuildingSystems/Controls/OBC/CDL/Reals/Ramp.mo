...
block Ramp "Limit the changing rate of the input"
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanInput active
...
way as <a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Reals.LimitSlewRate\">
BuildingSystems.Controls.OBC.CDL.Reals.LimitSlewRate</a>. However, the
