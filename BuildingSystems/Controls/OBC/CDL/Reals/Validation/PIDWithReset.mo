within BuildingSystems.Controls.OBC.CDL.Reals.Validation;
model PIDWithReset
  "Test model for LimPID controller with reset trigger"
  BuildingSystems.Controls.OBC.CDL.Conversions.BooleanToReal setPoi
    "Set point"
    annotation (Placement(transformation(extent={{-20,-40},{0,-20}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.CivilTime modTim
    "Civil time"
    annotation (Placement(transformation(extent={{-80,-70},{-60,-50}})));
  BuildingSystems.Controls.OBC.CDL.Reals.GreaterThreshold greEquThr(
    t=1)
    "Outputs true after t=1"
    annotation (Placement(transformation(extent={{-52,-70},{-32,-50}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PIDWithReset limPIDPar(
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,60},{80,80}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PIDWithReset limPIDInp(
    controllerType=BuildingSystems.Controls.OBC.CDL.Types.SimpleController.PID,
    k=1,
    Ti=1,
    Td=1,
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes2
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,20},{80,40}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Constant resVal(
    k=0)
    "Reset value"
    annotation (Placement(transformation(extent={{-80,-10},{-60,10}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PIDWithReset limPIPar(
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes3
    "Integrator whose output should be brought to the set point"
    annotation (Placement(transformation(extent={{60,-40},{80,-20}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PIDWithReset limPIInp(
    controllerType=BuildingSystems.Controls.OBC.CDL.Types.SimpleController.PI,
    k=1,
    Ti=1,
    Td=1,
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes4
    "Integrator whose output should be brought to the set point"
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PIDWithReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Reals.PID\">
BuildingSystems.Controls.OBC.CDL.Reals.PID</a>.
</p>
<p>
