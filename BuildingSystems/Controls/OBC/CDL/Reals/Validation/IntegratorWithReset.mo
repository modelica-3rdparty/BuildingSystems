...
model IntegratorWithReset
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intDef(final
      y_start=-2)
    "Integrator with default values"
    annotation (Placement(transformation(extent={{0,60},{20,80}})));
  BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset intWitRes1(final
      y_start=-2,
    final k=0.5)
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Constant cons(
    final k=10)
    "Constant as source term"
    annotation (Placement(transformation(extent={{-60,60},{-40,80}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.Pulse booleanPulse(
    final width=0.5,
    final period=0.2)
    "Boolean pulse"
    annotation (Placement(transformation(extent={{-60,-80},{-40,-60}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.SampleTrigger sampleTrigger(
    final period=0.2)
    "Sample trigger"
    annotation (Placement(transformation(extent={{-60,0},{-40,20}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Ramp ramp(
    final height=-1,
    final duration=1,
    final offset=-2)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/IntegratorWithReset.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model tests the implementation of
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset\">
BuildingSystems.Controls.OBC.CDL.Reals.IntegratorWithReset</a>
