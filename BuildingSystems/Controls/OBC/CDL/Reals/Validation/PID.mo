...
model PID
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.PID limPID(
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.PID limPI(
    Ti=1,
    Td=1,
    yMin=-1,
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.PID limPD(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=BuildingSystems.Controls.OBC.CDL.Types.SimpleController.PD)
    "PD controller"
    annotation (Placement(transformation(extent={{-30,-30},{-10,-10}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PID limP(
    Ti=1,
    Td=1,
    yMin=-1,
    controllerType=BuildingSystems.Controls.OBC.CDL.Types.SimpleController.P)
    "P controller"
    annotation (Placement(transformation(extent={{-30,-60},{-10,-40}})));
  BuildingSystems.Controls.OBC.CDL.Reals.PID noLimPID(
    Ti=1,
    Td=1,
    yMax=1e15,
    yMin=-1e15,
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/CDL/Reals/Validation/PID.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
