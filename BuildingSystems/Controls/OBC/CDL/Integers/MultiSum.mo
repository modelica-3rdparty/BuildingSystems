within BuildingSystems.Controls.OBC.CDL.Integers;
block MultiSum
  ...
  parameter Integer k[nin]=fill(1, nin)
    "Input gains";
  BuildingSystems.Controls.OBC.CDL.Interfaces.IntegerInput u[nin]
    "Inputs to be multipled with gain and added"
    annotation (Placement(transformation(extent={{-140,70},{-100,-70}})));
  BuildingSystems.Controls.OBC.CDL.Interfaces.IntegerOutput y
...
<p>
See
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Integers.Validation.MultiSum\">
BuildingSystems.Controls.OBC.CDL.Integers.Validation.MultiSum</a>
for an example.
</p>
</html>",
      revisions="<html>
