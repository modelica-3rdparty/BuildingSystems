...
model Multiply "Validation model for the Multiply block"
  BuildingSystems.Controls.OBC.CDL.Integers.Multiply product
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/CDL/Integers/Validation/Multiply.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
Validation test for the block
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Integers.Multiply\">
BuildingSystems.Controls.OBC.CDL.Integers.Multiply</a>.
</p>
</html>",
revisions="<html>
<ul>
