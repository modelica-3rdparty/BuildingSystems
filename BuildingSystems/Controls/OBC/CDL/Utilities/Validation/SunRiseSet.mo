...
model SunRiseSet
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-06),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/CDL/Utilities/Validation/SunRiseSet.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This example includes four instances of the
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Utilities.SunRiseSet\">
BuildingSystems.Controls.OBC.CDL.Utilities.SunRiseSet</a> block:
