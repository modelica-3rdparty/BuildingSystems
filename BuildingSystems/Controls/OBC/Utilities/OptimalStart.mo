...
block OptimalStart
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput TSetZonHea(
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput TZon(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
    min=200)
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput TSetZonCoo(
    final quantity="ThermodynamicTemperature",
    final unit="K",
    displayUnit="degC",
  ...
  BuildingSystems.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optHea(
  ...
  BuildingSystems.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation optCoo(
    final tOptMax=tOptMax,
    final thrOptOn=thrOptOn,
    final nDay=nDay,
    final uLow=uLow,
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.GreaterThreshold hysSta(
    t=60,
    h=60)
...
protected
  BuildingSystems.Controls.OBC.CDL.Reals.Max max
    "Get the maximum optimal start time "
    annotation (Placement(transformation(extent={{100,30},{120,50}})));
  BuildingSystems.Controls.OBC.CDL.Reals.AddParameter addPar(
    p=-tOptMax)
    "Maximum optimal start time"
    annotation (Placement(transformation(extent={{-100,-10},{-80,10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Or or2
    "Get the optimal start boolean output"
    annotation (Placement(transformation(extent={{100,-50},{120,-30}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Subtract dTHea if computeHeating
    "Temperature difference between heating setpoint and zone temperature"
    annotation (Placement(transformation(extent={{-80,70},{-60,90}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Subtract dTCoo if computeCooling
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Constant con2(
    final k=0) if not computeHeating
    "Becomes effective when optimal start is only for heating"
    annotation (Placement(transformation(extent={{60,40},{80,60}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Constant con1(
    final k=0) if not computeCooling
    "Becomes effective when optimal start is only for cooling"
    annotation (Placement(transformation(extent={{60,10},{80,30}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.Constant con(
    final k=false) if not computeHeating
    "Becomes effective when optimal start is only for heating"
    annotation (Placement(transformation(extent={{60,-30},{80,-10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Sources.Constant con3(
...
The base class
<a href=\"modelica://BuildingSystems.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation\">
BuildingSystems.Controls.OBC.Utilities.BaseClasses.OptimalStartCalculation</a> is used
for the calculation.
</p>
<h4>Algorithm</h4>
<p>
...
<a href=\"modelica://BuildingSystems.Controls.OBC.CDL.Discrete.TriggeredMovingMean\">
BuildingSystems.Controls.OBC.CDL.Discrete.TriggeredMovingMean</a> for details about
...
<a href=\"modelica://BuildingSystems.Controls.OBC.Utilities.Validation\">
BuildingSystems.Controls.OBC.Utilities.Validation</a>.
</p>
</html>",
      revisions="<html>
<ul>
