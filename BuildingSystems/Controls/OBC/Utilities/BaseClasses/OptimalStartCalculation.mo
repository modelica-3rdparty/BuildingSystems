within BuildingSystems.Controls.OBC.Utilities.BaseClasses;
block OptimalStartCalculation
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput TDif(
    final quantity="TemperatureDifference",
    final unit="K")
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanInput staCal
    "Start calculation"
    annotation (Placement(transformation(extent={{-320,20},{-280,60}}),
      iconTransformation(extent={{-140,-20},{-100,20}})));
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealInput tNexOcc(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.RealOutput tOpt(
    final quantity="Time",
    final unit="s",
    displayUnit="h")
  ...
  BuildingSystems.Controls.OBC.CDL.Interfaces.BooleanOutput optOn
...
protected
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Divide temSlo
    "Calculate temperature slope"
    annotation (Placement(transformation(extent={{0,-10},{20,10}})));
  BuildingSystems.Controls.OBC.CDL.Logical.Pre pre
    "Break algebraic loops"
    annotation (Placement(transformation(extent={{390,-16},{410,4}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Subtract sub1
    "Calculate the time duration to reach the setpoint"
    annotation (Placement(transformation(extent={{-88,-10},{-68,10}})));
  BuildingSystems.Controls.OBC.CDL.Reals.Subtract sub2
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Min min
    "Get the final optimal start time"
    annotation (Placement(transformation(extent={{240,-16},{260,4}})));
  BuildingSystems.Controls.OBC.CDL.Discrete.TriggeredSampler triSam
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Switch dTUse
    "dT used in the calculations (to avoid negative dT)"
    annotation (Placement(transformation(extent={{80,70},{100,90}})));
  BuildingSystems.Controls.OBC.CDL.Reals.GreaterThreshold reqStaUp(
    final t=0,
    final h=0)
    "Output true if optimal startup is needed"
    annotation (Placement(transformation(extent={{10,70},{30,90}})));
  BuildingSystems.Controls.OBC.CDL.Logical.And triAve
...
<a href=\"modelica://BuildingSystems.Controls.OBC.Utilities.OptimalStart\">
BuildingSystems.Controls.OBC.Utilities.OptimalStart</a>.
</p>
</html>",
      revisions="<html>
<ul>
