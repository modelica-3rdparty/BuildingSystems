...
model OptimalStartCoolingNegativeStartTime
  ...
  BuildingSystems.Controls.OBC.Utilities.OptimalStart optStaCoo(
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Sources.Sin TOut(
    amplitude=5,
    freqHz=1/86400,
    offset=28+273.15,
    startTime(
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.MultiplyByParameter UA(k=100)
  ...
  BuildingSystems.Controls.OBC.CDL.Reals.Add dTdt
    "Temperature derivative"
    annotation (Placement(transformation(extent={{-80,0},{-60,20}})));
  BuildingSystems.Controls.OBC.CDL.Reals.MultiplyByParameter QCoo(k=-2000)
    "Heat extraction in the zone"
    annotation (Placement(transformation(extent={{-120,-60},{-100,-40}})));
  BuildingSystems.Controls.OBC.CDL.Conversions.BooleanToReal booToRea(
    realTrue=-6)
...
equation
  ...
  annotation (
    experiment(
      ...
      Tolerance=1e-07),
    __Dymola_Commands(
      file="modelica://BuildingSystems/Resources/Scripts/Dymola/Controls/OBC/Utilities/Validation/OptimalStartCoolingNegativeStartTime.mos" "Simulate and plot"),
    Documentation(
      info="<html>
<p>
This model is to validate the block
<a href=\"modelica://BuildingSystems.Controls.OBC.Utilities.OptimalStart\">
BuildingSystems.Controls.OBC.Utilities.OptimalStart</a> for space cooling system with
