...
model BoreholeDynamics "Example model for different borehole models and dynamics"
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT sin2(
    ...
    T=283.15) "Sink" annotation (Placement(transformation(extent={{80,-70},{60,-50}},
                  rotation=0)));
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFie2UTubDat(
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFieUTubDatSteSta(filDat=
        BuildingSystems.Fluid.Geothermal.Borefields.Data.Filling.Bentonite(
        steadyState=true))
  ...
  parameter BuildingSystems.Fluid.Geothermal.Borefields.Data.Borefield.Example borFie2UTubDatSteSta(
