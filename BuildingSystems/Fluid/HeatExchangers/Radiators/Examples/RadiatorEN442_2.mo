...
model RadiatorEN442_2 "Test model for radiator"
 ...
 package Medium = BuildingSystems.Media.Water "Medium model";
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort senTemRad1In(
