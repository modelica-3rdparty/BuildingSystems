...
model PartialEffectivenessNTU
  ...
  parameter BuildingSystems.Fluid.Types.HeatExchangerConfiguration configuration "Heat exchanger configuration"
...
protected
  ...
  parameter BuildingSystems.Fluid.Types.HeatExchangerFlowRegime flowRegime_nominal(fixed=false)
    "Heat exchanger flow regime at nominal flow rates";
  BuildingSystems.Fluid.Types.HeatExchangerFlowRegime flowRegime(fixed=false, start=flowRegime_nominal)
...
initial equation
  ...
  if (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed) then
    flowRegime_nominal = if (C1_flow_nominal < C2_flow_nominal) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed
       else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed;
  elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed) then
    flowRegime_nominal = if (C1_flow_nominal < C2_flow_nominal) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed
       else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed;
  elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow) then
    flowRegime_nominal = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow;
  elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CounterFlow) then
    flowRegime_nominal = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CounterFlow;
  elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed) then
    flowRegime_nominal = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed;
  else
    // Invalid flow regime. Assign a value to flowRegime_nominal, and stop with an assert
    flowRegime_nominal = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed;
    assert(configuration >= BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow and configuration <= BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed,
...
equation
  ...
  if use_dynamicFlowRegime then
    if (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow) then
      flowRegime = if (C1_flow*C2_flow >= 0) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CounterFlow;
    elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CounterFlow) then
      flowRegime = if (C1_flow*C2_flow >= 0) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CounterFlow else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow;
    elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed) then
      flowRegime = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed;
    elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed) then
      flowRegime = if (C1_flow < C2_flow) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed
         else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed;
    else
      // have ( configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1UnmixedStream2Mixed)
      flowRegime = if (C1_flow < C2_flow) then BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed
         else BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed;
    end if;
  else
