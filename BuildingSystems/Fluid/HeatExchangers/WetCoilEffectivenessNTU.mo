...
model WetCoilEffectivenessNTU
  ...
  parameter BuildingSystems.Fluid.Types.HeatExchangerConfiguration configuration=
    BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CounterFlow
...
initial equation
  ...
  if (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowStream1MixedStream2Unmixed) then
    flowRegime_nominal = if (C1_flow_nominal < C2_flow_nominal)
      then
        BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinMixedCMaxUnmixed
      else
        BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowCMinUnmixedCMaxMixed;
  ...
  elseif (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.CrossFlowUnmixed) then
    ...
    flowRegime_nominal = BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.CrossFlowUnmixed;
    assert(configuration >= BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow and
  ...
  if use_dynamicFlowRegime then
    if (configuration == BuildingSystems.Fluid.Types.HeatExchangerConfiguration.ParallelFlow) then
      flowRegime = if (C1_flow*C2_flow >= 0)
        then
          BuildingSystems.Fluid.Types.HeatExchangerFlowRegime.ParallelFlow
        else
