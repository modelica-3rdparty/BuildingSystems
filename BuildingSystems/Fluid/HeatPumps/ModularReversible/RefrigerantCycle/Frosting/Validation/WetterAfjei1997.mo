within BuildingSystems.Fluid.HeatPumps.ModularReversible.RefrigerantCycle.Frosting.Validation;
model WetterAfjei1997
  ...
  BuildingSystems.Fluid.HeatPumps.ModularReversible.BaseClasses.RefrigerantMachineControlBus
    sigBus1
...
equation
  ...
  annotation (   __Dymola_Commands(file=
     "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/HeatPumps/ModularReversible/RefrigerantCycle/Frosting/Validation/WetterAfjei1997.mos"
        "Simulate and plot"),
  experiment(
      StartTime=0,
      StopTime=35,
