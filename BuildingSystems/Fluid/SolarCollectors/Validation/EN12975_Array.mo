...
model EN12975_Array
  ...
  model Collector
    extends BuildingSystems.Fluid.SolarCollectors.EN12975(
    redeclare final package Medium = BuildingSystems.Media.Water,
    final show_T = true,
    final per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel(),
    final shaCoe=0,
    final azi=0,
    final energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    final rho=0.2,
    final nColType=BuildingSystems.Fluid.SolarCollectors.Types.NumberSelection.Number,
    nPanels=1,
  ...
  Collector solCol(
    nPanels=4,
    nSeg=3,
    sysConfig=BuildingSystems.Fluid.SolarCollectors.Types.SystemConfiguration.Array,
    nPanelsPar=2)
...
<a href=\"https://github.com/lbl-srg/modelica-buildings/issues/3604\">Buildings, #3604</a>.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/EN12975_Array.mos"
        "Simulate and plot"),
