...
model ExtremeAmbientConditions
  ...
  replaceable package Medium = BuildingSystems.Media.Water(T_min=273.15, T_max=273.15+100)
  ...
  ASHRAE93 solAsh(
    ...
    per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_GuangdongFSPTY95(),
    nPanels=1,
    azi=0.3,
    til=0.5,
  ...
  EN12975 solEn(
    ...
    azi=0.3,
    til=0.5,
    per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_VerificationModel(),
...
BuildingSystems.Fluid.SolarCollectors.ASHRAE93</a>
and
<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.EN12975\">
BuildingSystems.Fluid.SolarCollectors.EN12975</a>.
</p>
<p>
Note that the medium has been declared
as <code>BuildingSystems.Media.Water(T_min=273.15, T_max=273.15+100)</code>
...
First implementation.
    ...
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/ExtremeAmbientConditions.mos"
        "Simulate and plot"),
