within BuildingSystems.Fluid.SolarCollectors.Validation;
model FlatPlate "Validation model for FlatPlate"
  ...
  BuildingSystems.Fluid.SolarCollectors.ASHRAE93
   solCol(
    redeclare package Medium = Medium,
    shaCoe=0,
    azi=0,
    per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation(),
  ...
  Modelica.Blocks.Sources.CombiTimeTable datRea(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
       "modelica://BuildingSystems/Resources/Data/Fluid/SolarCollectors/Validation/FlatPlate/TRNSYSAnnualData.txt"),
...
BuildingSystems.Fluid.SolarCollectors.ASHRAE93</a> solar collector model
against TRNSYS data. Data files are used to ensure that the
<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.ASHRAE93\">
BuildingSystems.Fluid.SolarCollectors.ASHRAE93</a> solar collector model and
the TRNSYS model use the same inlet and weather conditions. The
solar collector model must reference the
<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation\">
BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_TRNSYSValidation</a>
...
First implementation.
  ...
  __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Validation/FlatPlate.mos"
    "Simulate and plot"),
