...
model FlatPlateTotalArea "Example showing the use of TotalArea and nSeg"
  ...
  BuildingSystems.Fluid.SolarCollectors.ASHRAE93 solCol1(
    redeclare package Medium = Medium,
    shaCoe=0,
    from_dp=true,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TOut1(
    redeclare package Medium = Medium,
    T_start(displayUnit="K"),
    m_flow_nominal=solCol.m_flow_nominal) "Temperature sensor"
    annotation (Placement(transformation(extent={{20,-40},{40,-20}})));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TIn1(
...
<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.Examples.FlatPlate\">
BuildingSystems.Fluid.SolarCollectors.Examples.FlatPlate</a>.
</p>
</html>",
revisions="<html>
<ul>
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Examples/FlatPlateTotalArea.mos"
        "Simulate and plot"),
