...
model Tubular "Example showing the use of Tubular"
  ...
  replaceable package Medium = BuildingSystems.Media.Water "Medium in the system";
  BuildingSystems.Fluid.SolarCollectors.ASHRAE93 solCol(
    redeclare package Medium = Medium,
    shaCoe=0,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    use_shaCoe_in=false,
    per=BuildingSystems.Fluid.SolarCollectors.Data.Tubular.T_AMKCollectraAGOWR20(),
    nPanels=10,
    sysConfig=BuildingSystems.Fluid.SolarCollectors.Types.SystemConfiguration.Parallel,
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TIn(redeclare package Medium =
...
equation
  ...
  annotation (__Dymola_Commands(file=
    "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Examples/Tubular.mos"
        "Simulate and plot"),
...
<p>
  ...
  BuildingSystems.Fluid.SolarCollectors.ASHRAE93</a> model and references
  data in the <a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.Data.Tubular\">
  BuildingSystems.Fluid.SolarCollectors.Data.Tubular</a> package.
</p>
</html>",
revisions="<html>
<ul>
