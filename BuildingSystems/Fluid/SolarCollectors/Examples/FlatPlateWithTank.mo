within BuildingSystems.Fluid.SolarCollectors.Examples;
model FlatPlateWithTank
  ...
  replaceable package Medium_2 = BuildingSystems.Media.Water "Fluid flowing through the collector";
  ...
  BuildingSystems.Fluid.SolarCollectors.ASHRAE93 solCol(
    redeclare package Medium = Medium_2,
    shaCoe=0,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    nColType=BuildingSystems.Fluid.SolarCollectors.Types.NumberSelection.Number,
    nPanels=5,
    sysConfig=BuildingSystems.Fluid.SolarCollectors.Types.SystemConfiguration.Series,
    per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_SolahartKf(),
    nSeg=9,
    final azi=azi,
    final til=til,
  ...
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TOut(
    T_start(displayUnit="K"),
    m_flow_nominal=m_flow_nominal,
    redeclare package Medium = Medium_2) "Temperature sensor"
    annotation (Placement(transformation(extent={{30,46},{50,66}})));
  BuildingSystems.Fluid.Sensors.TemperatureTwoPort TIn(m_flow_nominal=m_flow_nominal,
    redeclare package Medium = Medium_2) "Temperature sensor"
    annotation (Placement(transformation(extent={{-34,46},{-14,66}})));
  BuildingSystems.Fluid.Storage.StratifiedEnhancedInternalHex
   tan(
    nSeg=4,
    ...
    annotation (Placement(transformation(
      extent={{-20,-20},{20,20}},
      origin={100,-20})));
  BuildingSystems.Fluid.SolarCollectors.Controls.CollectorPump pumCon(
    per=BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_ThermaLiteHS20(),
    final azi=azi,
    final til=til,
    final rho=rho)
    "Pump controller"
  ...
  BuildingSystems.Fluid.Sources.Boundary_pT bou(redeclare package Medium =
...
equation
  ...
  connect(pum.m_flow_in, booToRea.y) annotation (Line(points={{-62,7.77156e-16},
    ...
    annotation(
   __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/Examples/FlatPlateWithTank.mos"
        "Simulate and plot"),
...
BuildingSystems.Fluid.Storage.StratifiedEnhancedInternalHex</a> (tan) model is
...
BuildingSystems.Fluid.Movers.FlowControlled_m_flow</a>, pum), 
passes the water through an expansion tank
(<a href=\"modelica://BuildingSystems.Fluid.Storage.ExpansionVessel\">
BuildingSystems.Fluid.Storage.ExpansionVessel</a>, exp),
a temperature sensor
(<a href=\"modelica://BuildingSystems.Fluid.Sensors.TemperatureTwoPort\">
BuildingSystems.Fluid.Sensors.TemperatureTwoPort</a>, TIn),
the solar collector
(<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.ASHRAE93\">
BuildingSystems.Fluid.SolarCollectors.ASHRAE93,</a> solCol),
and a second temperature sensor
(<a href=\"modelica://BuildingSystems.Fluid.Sensors.TemperatureTwoPort\">
BuildingSystems.Fluid.Sensors.TemperatureTwoPort</a>, TOut)
...
BuildingSystems.BoundaryConditions.WeatherData.ReaderTMY3</a>, weaDat) which passes
...
(<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.Controls.CollectorPump\">
BuildingSystems.Fluid.SolarCollectors.Controls.CollectorPump</a>, pumCon)
and a gain model.
...
<p>
bou1 (<a href=\"modelica://BuildingSystems.Fluid.Sources.MassFlowSource_T\">
BuildingSystems.Fluid.Sources.MassFlowSource_T)</a> provides a constant mass flow
