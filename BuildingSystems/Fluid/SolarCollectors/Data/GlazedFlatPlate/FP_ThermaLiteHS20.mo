within BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate;
record FP_ThermaLiteHS20 =
    BuildingSystems.Fluid.SolarCollectors.Data.GenericASHRAE93 (
    final A=1.97,
    final CTyp=BuildingSystems.Fluid.SolarCollectors.Types.HeatCapacity.DryMass,
    final C=0,
    final mDry=26,
    final V=2.8/1000,
