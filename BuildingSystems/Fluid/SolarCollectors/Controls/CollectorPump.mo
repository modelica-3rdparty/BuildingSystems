within BuildingSystems.Fluid.SolarCollectors.Controls;
model CollectorPump
  ...
  BuildingSystems.BoundaryConditions.WeatherData.Bus weaBus "Weather data input"
    annotation (Placement(transformation(extent={{-110,40},{-90,60}})));

  BuildingSystems.Fluid.SolarCollectors.Controls.BaseClasses.GCritCalc criSol(
...
Moved old model to <code>BuildingSystems.Obsolete</code> package.<br/>
This is for
