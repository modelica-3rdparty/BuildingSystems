within BuildingSystems.Fluid.SolarCollectors;
model EN12975 "Model of a solar thermal collector according to the ASHRAE Standard 93"
  extends BuildingSystems.Fluid.SolarCollectors.BaseClasses.PartialSolarCollector(
    redeclare BuildingSystems.Fluid.SolarCollectors.Data.GenericEN12975 per);
