...
model ASHRAESolarGain "Example showing the use of ASHRAESolarGain"
  ...
  parameter BuildingSystems.Fluid.SolarCollectors.Data.GenericASHRAE93 per=
    BuildingSystems.Fluid.SolarCollectors.Data.GlazedFlatPlate.FP_ThermaLiteHS20()
    "Performance data"
    annotation (choicesAllMatching=true);
  BuildingSystems.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain solGai(
    nSeg=3,
...
<a href=\"modelica://BuildingSystems.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain\">
BuildingSystems.Fluid.SolarCollectors.BaseClasses.ASHRAESolarGain</a>.
</p>
</html>",
revisions="<html>
<ul>
...
First implementation.
    ...
    __Dymola_Commands(file=
          "modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/SolarCollectors/BaseClasses/Examples/ASHRAESolarGain.mos"
        "Simulate and plot"),
