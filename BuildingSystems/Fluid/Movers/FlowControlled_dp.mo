...
model FlowControlled_dp
  ...
  extends BuildingSystems.Fluid.Movers.BaseClasses.PartialFlowMachine(
    ...
    eff(per(
        ...
        final etaHydMet=if (per.etaHydMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.Power_VolumeFlowRate
          or per.etaHydMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber)
          and not per.havePressureCurve then
            BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.NotProvided
          else
            per.etaHydMet,
        final etaMotMet=if (per.etaMotMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.Efficiency_MotorPartLoadRatio
          or per.etaMotMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.MotorEfficiencyMethod.GenericCurve)
