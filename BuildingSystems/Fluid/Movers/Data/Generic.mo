...
record Generic "Generic data record for movers"
  ...
  final parameter BuildingSystems.Fluid.Movers.BaseClasses.Euler.peak peak_internal=
    if etaHydMet == BuildingSystems.Fluid.Movers.BaseClasses.Types.HydraulicEfficiencyMethod.EulerNumber
    then BuildingSystems.Fluid.Movers.BaseClasses.Euler.getPeak(pressure=pressure,power=power)
    else BuildingSystems.Fluid.Movers.BaseClasses.Euler.peak(V_flow=V_flow_max/2,
                                                   dp=dpMax/2,
