...
model ComparePowerHydraulic
  ...
  extends BuildingSystems.Fluid.Movers.Validation.BaseClasses.ComparePower(
    redeclare replaceable BuildingSystems.Fluid.Movers.Data.Fans.Greenheck.BIDW15 per(
    ...
    redeclare BuildingSystems.Fluid.Movers.SpeedControlled_y mov1(
      ...
      use_riseTime=false),
    redeclare BuildingSystems.Fluid.Movers.SpeedControlled_y mov2(
      redeclare final package Medium = Medium,
      per(
      ...
      addPowerToMedium=false,
      use_riseTime=false),
    redeclare BuildingSystems.Fluid.Movers.SpeedControlled_y mov3(
      redeclare final package Medium = Medium,
      per(
        powerOrEfficiencyIsHydraulic=per.powerOrEfficiencyIsHydraulic,
        pressure=per.pressure,
  ...
  final parameter BuildingSystems.Fluid.Movers.BaseClasses.Euler.peak peak =
    BuildingSystems.Fluid.Movers.BaseClasses.Euler.getPeak(
      pressure=per.pressure,
      power=per.power)
...
equation
  ...
  annotation(experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Movers/Validation/ComparePowerHydraulic.mos"
        "Simulate and plot"),
