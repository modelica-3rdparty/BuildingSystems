...
model ComparePowerTotal
  ...
  extends BuildingSystems.Fluid.Movers.Validation.ComparePowerHydraulic(
    redeclare BuildingSystems.Fluid.Movers.Data.Pumps.Wilo.Stratos40slash1to12 per);
annotation(experiment(Tolerance=1e-6, StopTime=200),
    __Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/Fluid/Movers/Validation/ComparePowerTotal.mos"
        "Simulate and plot"),
