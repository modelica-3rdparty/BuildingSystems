...
model ThreeWayValveParameterization
  ...
  BuildingSystems.Fluid.Actuators.Valves.ThreeWayEqualPercentageLinear valOpePoi(
  ...
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFloOpPoi(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{20,80},{40,100}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFloKv(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{20,20},{40,40}})));
  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFloCv(
    redeclare package Medium = Medium) "Mass flow rate sensor"
    annotation (Placement(transformation(extent={{20,-40},{40,-20}})));

  BuildingSystems.Fluid.Sensors.MassFlowRate senMasFloAv(redeclare package Medium =
