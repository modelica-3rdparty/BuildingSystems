...
partial model PartialThreeWayValve "Partial three way valve"
  extends BuildingSystems.Fluid.BaseClasses.PartialThreeWayResistance(
    ...
    redeclare replaceable BuildingSystems.Fluid.Actuators.BaseClasses.PartialTwoWayValve res1
    ...
    redeclare replaceable BuildingSystems.Fluid.Actuators.BaseClasses.PartialTwoWayValve res3
      constrainedby BuildingSystems.Fluid.Actuators.BaseClasses.PartialTwoWayValve(
        deltaM=deltaM,
        from_dp=from_dp,
