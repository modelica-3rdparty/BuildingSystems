...
model PressureDropsParallel
  ...
  BuildingSystems.Fluid.FixedResistances.PressureDrop res3(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    dp_nominal=10,
    deltaM=0.3,
  ...
  BuildingSystems.Fluid.Sensors.MassFlowRate masFlo3(redeclare package Medium = Medium)
  ...
  BuildingSystems.Fluid.FixedResistances.HydraulicDiameter noRes(
    redeclare package Medium = Medium,
    m_flow_nominal=5,
    linearized=false,
    from_dp=true,
