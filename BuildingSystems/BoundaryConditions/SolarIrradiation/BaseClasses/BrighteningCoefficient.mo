...
protected
  ...
  Real b8;
equation
  b1 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=1.065 - skyCle,
    x_small=d);
  b2 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=1.23 - skyCle,
    x_small=d);
  b3 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=1.50 - skyCle,
    x_small=d);
  b4 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=1.95 - skyCle,
    x_small=d);
  b5 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=2.80 - skyCle,
    x_small=d);
  b6 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=4.50 - skyCle,
    x_small=d);
  b7 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=6.20 - skyCle,
    x_small=d);
  b8 = BuildingSystems.Utilities.Math.Functions.regStep(
    y1=1,
    y2=0,
    x=skyCle - 6.20,
    x_small=d);
