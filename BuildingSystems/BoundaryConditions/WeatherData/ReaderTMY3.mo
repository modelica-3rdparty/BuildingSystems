  ...
  annotation (
    ...
    Icon(coordinateSystem(
        ...
        Text(
          ...
          textString="HGloHor"),
        Text(
          visible=(HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HGloHor_HDifHor or HSou == BuildingSystems.BoundaryConditions.Types.RadiationDataSource.Input_HDirNor_HDifHor),
...
<code>BuildingSystems/Resources/bin/convert_weather_data.py</code> that converts
