within BuildingSystems.ThermalZones.ISO13790.Validation.BESTEST.Cases9xx;
model Case950FF
  extends BuildingSystems.ThermalZones.ISO13790.Validation.BESTEST.Cases9xx.Case900FF(
      zonHVAC(nPorts=3));
  BuildingSystems.Fluid.Sources.MassFlowSource_T sinInf(
    redeclare package Medium = BuildingSystems.Media.Air,
    use_m_flow_in=true,
    nPorts=1) "Sink model for air infiltration"
    annotation (Placement(transformation(extent={{8,-80},{-12,-60}})));
  BuildingSystems.Fluid.Sources.Outside out(redeclare package Medium = BuildingSystems.Media.Air, nPorts=1)
  ...
  BuildingSystems.Fluid.Sensors.Density senDen(redeclare package Medium = BuildingSystems.Media.Air,
...
__Dymola_Commands(file="modelica://BuildingSystems/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases9xx/Case950FF.mos"
