...
model Case650
  extends BuildingSystems.ThermalZones.ISO13790.Validation.BESTEST.Cases6xx.Case600(zonHVAC(
        nPorts=3), gaiHea(k=0),
  ...
  BuildingSystems.Fluid.Sources.Outside out(redeclare package Medium = BuildingSystems.Media.Air,
                                                                  nPorts=1)
...
equation
 ...
 annotation(experiment(
  ...
  "modelica://BuildingSystems/Resources/Scripts/Dymola/ThermalZones/ISO13790/Validation/BESTEST/Cases6xx/Case650.mos"
